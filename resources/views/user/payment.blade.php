...
<div class="container">
    ...
    <div class="py-5 text-center">
            <a href="{{route('showcart')}}" class="btn btn-info" style="margin-right: 1000px "><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
       ...
       <p class="alert-danger"> {{session()->get('alert')}}<p>
            ...
            <ul class="list-group mb-3 sticky-top">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        ...
                        <small class="text-muted"><img src="/productimages/{{$carts->image}}" height="120px" width="100px" alt="">
                        </small>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="post" enctype="multipart/form-data" action="{{route('placeorder')}}">
                ...
                <div class="form-group form-check">
                    <input type="checkbox" class="form-check-input" id="cash-on-delivery" name="cash-on-delivery" required>
